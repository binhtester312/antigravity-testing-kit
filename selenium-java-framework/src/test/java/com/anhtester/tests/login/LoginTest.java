...
public class LoginTest extends BaseTest {
    ...
    public void TC_003_loginWithBothFieldsEmpty() {
        ...
        // Kiểm tra lỗi Email
        Assert.assertTrue(loginPage.isEmailFieldErrorDisplayed() || loginPage.isServerErrorDisplayed(),
            "TC_003 FAIL: Không hiển thị lỗi khi để trống Email.");

        // Kiểm tra lỗi Password
        Assert.assertTrue(loginPage.isPasswordFieldErrorDisplayed() || loginPage.isServerErrorDisplayed(),
    ...
    public void TC_012_loginWithSingleCharPassword() {
        ...
        Assert.assertFalse(loginPage.isPasswordFieldErrorDisplayed(),
